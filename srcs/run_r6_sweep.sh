#!/usr/bin/env bash
# r6 parallel seed farm: seeds {1 2 3 5 10} in scratch copies (SEED 7 is
# fit_r6_2 in-tree).  Each copy: full compile + r5hist domain panels.
set -uo pipefail
cd "$(dirname "$0")"
FARM=/tmp/claude-1000/r6farm
mkdir -p "$FARM"
